...
class _VideoDetailViewState extends State<_VideoDetailView> {
  ...
  Widget _buildDetailView(VideoDetailController controller) {
    ...
    final coverUrl = DetailPlayParser.resolveImageUrl(detail.vodPic, source: controller.source);
    final totalEpisodes = controller.playLines.fold<int>(0, (sum, line) => sum + line.episodes.length);
        ...
        Container(
          ...
          child: AspectRatio(
            ...
            child: controller.currentEpisodeUrl != null
                ? VideoPlayContainer(
                    // 💥 最关键的 Key，保证切集数时播放器彻底销毁重建
                    key: ValueKey<String>('${controller.currentEpisodeUrl!}_${controller.selectedLineIndex}_${controller.selectedEpisodeIndex}'),
                    ...
                    referer: controller.source.detailUrl.isNotEmpty ? controller.source.detailUrl : controller.source.url,
                    showDebugInfo: false,
                    onPreviousEpisode: controller.canPlayPrevious() ? controller.playPrevious : null,
                    onNextEpisode: controller.canPlayNext() ? controller.playNext : null,
                  )
            ...
            child: ListView(
              ...
              children: [
                DetailInfoCard(
                  ...
                  currentEpisodeName: controller.currentEpisodeName ?? '未选择',
                ),
                const SizedBox(height: 16),
                if (controller.playLines.isEmpty)
                  ...
                  DetailEpisodeSection(
                    episodes: controller.playLines[controller.selectedLineIndex].episodes,
